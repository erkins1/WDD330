...
//Current Issues:
//  needs to run the addEvents function after the lis are created
//  drag events don't work on touch....


//Apply the event listener to each li in the ul
const ulList = document.querySelector("#usrVacation");
...
function dragEndHandler(event){
    if(event.dataTransfer.dropEffect == "move"){
        ...
        addDragEvents();
        //                      Need to save the changes around here
    }
}
