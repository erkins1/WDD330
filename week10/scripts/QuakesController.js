...
`;
        ...
        this.parentElement.addEventListener('touchend', e => {
            this.getQuakeDetails(e.path[1].dataset.id);
        });

        document.querySelector("#backButton").addEventListener('touchend', backButton);
...
function backButton() {
    new QuakesController("#quakeList").init();
    document.querySelector("#backButton").innerHTML = "";
    document.querySelector("#backButton").removeEventListener('touchend', backButton);
}